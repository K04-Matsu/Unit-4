...
from makers_manager.core.views import core
from makers_manager.users.views import users
from makers_manager.blog_posts.views import blog_posts
from makers_manager.error_pages.handlers import error_pages
